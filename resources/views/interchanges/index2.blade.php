    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading clearfix"> <h4 class="panel-title pull-left panelUp"><b>Intercambios que yo he solicitado.</b></h4>
                    <button type="button" class="btn btn-primary pull-right">He solicitado: &nbsp;<span class="badge"> {{ $howinter }} </span>&nbsp; artículos.</button>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <form action="{{ url('interchange', $interchange->id) }}" method="POST" class="form-inline" onsubmit="return confirmDeliver();">
                                                    {{ csrf_field() }}
                                                    {{ method_field('PUT') }}
                                                    <button type="submit" class="btn btn-success btn-xs" title="Entregado" @if($interchange->status == 'canceled' or $interchange->status == 'checked' or $interchange->status == 'solicited') disabled @endif>
...
<script type="text/javascript">
   ...
   function confirmDeliver(){
       if (!confirm("¿Ya te ha llegado el artículo?")) {
           return false;
       }
   }
</script>
