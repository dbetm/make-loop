    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading clearfix"> <h4 class="panel-title pull-left panelUp"><b>Nuevo artículo</b></h4>
                    <a href="{{ url('articles/index') }}" class="btn btn-primary pull-right">
                        <i class="fa fa-th-list"></i> Ver artículos
                    </a>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/articles/create') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('points') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-2">
                                <input id="points" type="number" min="1" max="100" class="form-control" name="points" value="{{ old('points') }}">
                        ...
                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="image" type="text" class="form-control" name="image" value="{{ old('image') }}" placeholder="URL">
                                @if ($errors->has('image'))
                                    <span class="help-block">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox" name="is_active">
                                    <label>
                                        <input type="checkbox" name="is_active" value="1" checked> Publicar al guardar
                                    </label>
                                </div>
                            </div>
                        </div>
